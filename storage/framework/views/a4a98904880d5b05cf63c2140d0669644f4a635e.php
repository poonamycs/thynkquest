  ...
  <div class="row">
    ...
    <div class="card">
            <div class="card-header">
              ...
              <a href="<?php echo e(url('admin/add-privacy-policy')); ?>" class="btn btn-primary thynk float-right">Add Privacy Policy</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo e(url('admin/edit-privacy-policy/'.$row->id)); ?>" class='btn btn-info' title="Edit Testimonial"><i class="fas fa-edit"></i></a>
                  </td>
                </tr>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/cms/view_privacy_policy.blade.php ENDPATH**/ ?>