                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="desc" rows="9" class="form-control textarea" required id="desc"><?php echo e($papers->description); ?></textarea>
                            </div>
                        </div>
                         <div class="col-md-12">
                            <div class="form-group">
                                <label for="title">Meta Title</label>
                                <input type="text" name="meta_title" class="form-control" value="<?php echo e($papers->meta_title); ?>" required id="title" placeholder="Enter meta title">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="title">Meta Keywords</label>
                                <input type="text" name="meta_keywords" class="form-control" value="<?php echo e($papers->meta_keywords); ?>" required id="title" placeholder="Enter meta keywords ">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="desc">Meta Description</label>
                                <textarea  name="meta_desc" class="form-control"  required id="desc" ><?php echo e($papers->meta_description); ?></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/papers/edit-papers.blade.php ENDPATH**/ ?>