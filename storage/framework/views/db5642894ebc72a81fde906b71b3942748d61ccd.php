...
<main>
         ...
         <section class="checkout-area pb-70">
               <div class="container">
               <form role="form" action="<?php echo e(route('course.payment')); ?>" method="post" class="validation"
                                                     data-cc-on-file="false"
                                                    data-stripe-publishable-key="pk_test_51J8kt1SADWwXOo9RnI8fDrhwZjDkM2LE3iIuHUo4FroxAzqzc2mJicwStmxgHZAt6xq4ziLJhjdzvWVto18VcLj8004EvNwzjB"
                                                    id="payment-form">
                  <?php echo csrf_field(); ?>
                                 ...
                                 <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="checkout-form-list">
                                             ...
                                             <input type="text" name="mobile" maxlength="10" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required placeholder="Enter phone number" />
                                          </div>
                                       </div>
                                       <h3>Card Details</h3>
                                       ...
                                       <div class="row pt-3">
                                          <div class="col-xs-12">
                                             <button class="btn btn-danger btn-lg btn-block" type="submit">Pay Now ( <?php echo e($course->price); ?> ) </button>
                                          </div>
                                       </div>
                                       ...
                                       <table>
                                          ...
                                          <tfoot>
                                             <tr class="cart-subtotal">
                                                   <th>Cart Subtotal</th>
                                                   <td><span class="amount">£ <?php echo e($course->price); ?>.00</span></td>
                                             </tr>
                                          
                                             <tr class="order-total">
                                                   <th>Order Total</th>
                                                   <td><strong><span class="amount">£ <?php echo e($course->price); ?>.00</span></strong>
                                                   </td>
                                             </tr>
                                          </tfoot>
                                       </table>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/pages/coures-checkout.blade.php ENDPATH**/ ?>