                  ...
                  <div class="col-xxl-12 col-xl-12 col-lg-12">
                     <div class="course__wrapper">
                        <div class="page__title-content mb-25">
                           ...
                           <span class="page__title-pre"><?php echo e($papers->cat_name); ?></span>
                           <h1 class="text-center"><?php echo e($papers->title); ?></h1>
                        </div>
                           <div class="course__description text-center">
                              <p style="font-size:25px;"><?php echo e($papers->description); ?></p>
                           </div>
                        <div class="course__img w-img">
                           <img src="assets/img/course/details/course-details-1.jpg" alt="">
                        </div>
                        <div class="course__enroll-btn text-center">
                           <a href="<?php echo e(url('/subscription')); ?>" class="e-btn w-50" style="height:70px;font-size:25px;padding-top:11px;">Subscribe Now<i class="far fa-arrow-right"></i></a>
                        </div>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/pages/course-detail.blade.php ENDPATH**/ ?>