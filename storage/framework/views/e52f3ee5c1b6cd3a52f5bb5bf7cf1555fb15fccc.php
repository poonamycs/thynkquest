...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Exam Style Paper Subscription</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Add Exam Style Paper Subscription</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-10">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Add Exam Style Paper Subscription</h3>
                <a href="<?php echo e(url('admin/view-esp-subscription')); ?>" class="btn btn-primary thynk float-right">View ESP Subscription</a>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="PaperForm" action="<?php echo e(url('admin/add-esp-subscription')); ?>" enctype='multipart/form-data' method="Post">
              <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="price" class="form-control" required id="price" placeholder="Enter subscription price">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="discount" class="form-control" required id="price" placeholder="Enter subscription discount" >
                            </div>
                        </div>
                    </div>
...
<script>
   $(document).ready(function () { 
            ...
            $.ajax({
                type:"get",
                    url:"<?php echo e(url('admin/esp-papers')); ?>",
                    data:{cat_id:cat_id},
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/subs/add-esp-subsription.blade.php ENDPATH**/ ?>