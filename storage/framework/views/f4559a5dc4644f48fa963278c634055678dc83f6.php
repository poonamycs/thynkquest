                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" class="form-control" value="<?php echo e($exampapers->meta_title); ?>" required id="title" placeholder="Enter meta title">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="title">Meta Keywords</label>
                                <input type="text" name="meta_keywords" class="form-control" value="<?php echo e($exampapers->meta_keywords); ?>" required id="title" placeholder="Enter meta keywords ">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="desc">Meta Description</label>
                                <textarea  name="meta_desc" class="form-control"  required id="desc" ><?php echo e($exampapers->meta_description); ?></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/exampapers/edit-papers.blade.php ENDPATH**/ ?>