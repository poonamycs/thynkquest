      ...
      <main>
         ...
         <section class="hero__area hero__height d-flex align-items-center grey-bg-2 p-relative">
            <div class="hero__shape">
               <img class="hero-1-circle" src="<?php echo e(asset('img/shape/hero/hero-1-circle.png')); ?>" alt="">
                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__content p-relative z-index-1">
                           <h3 class="hero__title">
                              ...
                              <span class="yellow-shape"> Your <img src="<?php echo e(asset('img/shape/yellow-bg.png')); ?>" alt="yellow-shape"> </span> 
                              one-stop entrance exam prep platform.</h3>
                        ...
                        <div class="hero__thumb d-flex p-relative">
                           ...
                           <div class="hero__thumb-big mr-30">
                              ...
                              <div class="hero__quote hero__quote-animation">
                                 ...
                                 <h4 class="mb-2">Personalised Asistant</h4>
               ...
               <div class="row">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">11+ Mark Schemes</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">Pre-11+ Foundation Courses</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">11+ Accelerating Courses</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">11+ Exam Booster Courses</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">13+ Scholarship Courses(</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">Mock Exams</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">Verbal Reasoning</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">Non Verbal Reasoning</a></h4>
                           <p>(11+ and 13+ resources)</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('course-detail')); ?>">English Creative Writing</a></h4>
                           <p>11+ and 13+ guide</p>
                        </div>
                     </div>
                  </div>
         ...
         <section class="banner__area pb-110">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div class="banner__item p-relative mb-40" data-background="<?php echo e(asset('img/banner/banner-bg-1.jpg')); ?>">
                        <div class="banner__content">
                           <span>Trending</span>
                           <h3 class="banner__title">
                              <a href="<?php echo e(url('course-detail')); ?>">Germany Foundation <br> Document</a>
                           </h3>
                           <a href="course-grid.html" class="e-btn e-btn-2">View Courses</a>
                        </div>
                        <div class="banner__thumb d-none d-sm-block d-md-none d-lg-block">
                           <img src="<?php echo e(asset('img/banner/banner-img-1.png')); ?>" alt="">
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div class="banner__item p-relative mb-40" data-background="<?php echo e(asset('img/banner/banner-bg-2.jpg')); ?>">
                        <div class="banner__content">
                           <span class="orange">Upcoming</span>
                           <h3 class="banner__title">
                              <a href="<?php echo e(url('course-detail')); ?>">Online Courses <br>From Eduka University</a>
                           </h3>
                        ...
                        <div class="banner__thumb banner__thumb-2 d-none d-sm-block d-md-none d-lg-block">
                           <img src="<?php echo e(asset('img/banner/banner-img-2.png')); ?>" alt="">
                        </div>
                     </div>
                  </div>
               </div>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/index.blade.php ENDPATH**/ ?>