               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="page__title-wrapper mt-145">
                        <h3 class="page__title">Personalized Assistance</h3>                         
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="contact__wrapper">
                        ...
                        <div class="contact__form">
                           <form action="<?php echo e(url('/personalized_enquiry')); ?>" method="post">
                               <?php echo csrf_field(); ?>
                              <div class="row">
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/cms/personalized_assistance.blade.php ENDPATH**/ ?>