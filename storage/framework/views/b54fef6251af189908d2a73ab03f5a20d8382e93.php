                                    ...
                                    <div class="row">
                                        <div class="sign__input-wrapper mb-25">
                                            ...
                                            <div class="sign__input">
                                                <input type="text" name="name" required value="<?php echo e(Auth::guard('web')->User()->fullname); ?>" required>
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Email</h5>
                                            <div class="sign__input">
                                                <input type="text" name="email" value="<?php echo e(Auth::guard('web')->User()->email); ?>" required>
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Mobile</h5>
                                            <div class="sign__input">
                                                <input type="text" name="phone" value="<?php echo e(Auth::guard('web')->User()->mobile); ?>" maxlength="10" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  value="{{ $profile->mobile }">
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/user/myprofile.blade.php ENDPATH**/ ?>