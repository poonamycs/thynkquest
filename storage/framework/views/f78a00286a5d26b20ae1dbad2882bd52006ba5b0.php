                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4">
                     <div class="course__wrapper">
                        <div class="page__title-content">
                           ...
                           <!-- <span class="page__title-pre"><?php echo e($examdetails->subcat_name); ?></span> -->
                          
                        </div>
                          
                        <div class="course__img w-img">
                           <img src="<?php echo e(asset('/images/exampapers/'.$examdetails->file)); ?>" width="100%" height="300" alt="<?php echo e($examdetails->title); ?>">
                           
                        </div>
                          <?php $title = Str::slug($examdetails->title); ?>
                           <div class="course__enroll-btn text-center pt-30">
                              <?php if($subscription != ""): ?>
                              <button type="button" disabled class="btn btn-success">Subscribed</button>
                              <?php else: ?>
                              <a href="<?php echo e(url('/exam-style-papers-subscription/'.$examdetails->id.'/'.$title)); ?>" class="e-btn w-100" style="height:59px;font-size:25px;padding-top:5px;">Subscribe Now<i class="far fa-arrow-right"></i></a>
                               <?php endif; ?>
...
<!-- 
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4">
                         <div class="course__description pt-50">
                              <h1 ><?php echo e(ucwords($examdetails->title)); ?></h1>
                              <?php if($examdetails->subcat_name != ""): ?>
                              <div class="events__tag">
                                 
                                 <h3><?php echo e($examdetails->subcat_name); ?></h3>
                              ...
                              <h3 class="mb-20"></h3>
                              <p style="font-size:20px;text-align:justify"><?php echo $examdetails->description; ?></p>
                           </div>
                                     ...
                                     <?php $__currentLoopData = $question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <div class="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                                          <div class="course__curriculum-info">
                                             <h3><a href="#" target="__blank"><?php echo e($rows->title); ?></a> </h3>
                                          </div>
                                          <div class="course__curriculum-meta">
                                             <?php if(Auth::check()): ?>  
                                                 ...
                                                 <?php else: ?>
                                                 <span class="time"> <i class="icon_clock_alt"></i><a href="#" onclick="SubscribeQues();" >Question</a></span>
                                                 <?php endif; ?>
                                             <?php else: ?>
                                             <span class="time"> <i class="icon_clock_alt"></i><a href="#" onclick="Login();" >Question</a></span>
                                             <?php endif; ?>
            
                                             
                                             <?php if(Auth::check()): ?> 
                                                 <?php if($subscription != ""): ?>
                                                 <span class="question"><a href="<?php echo e(url('/exam-style-papers/view-answers/'.$rows->id)); ?>">Answer</a></span>
...
<script>
   ...
   function Login(){
      ...
      $('#res').html('<div class="alert alert-danger">You Have not logged in please login to use the functionality.</div>');
      setTimeout(function(){
         window.location.reload(1);
      }, 10000);
   }
   function SubscribeQues(){
      
      $('#res').html('<div class="alert alert-danger">To view the question, please subscribe to the package.</div>');
      setTimeout(function(){
         window.location.reload(1);
      }, 10000);
   }
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/exams/examdetails.blade.php ENDPATH**/ ?>