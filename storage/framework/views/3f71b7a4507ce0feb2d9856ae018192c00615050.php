                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="desc" rows="9" class="form-control" required id="desc" placeholder="Enter paper small description"></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/papers/add-13papers.blade.php ENDPATH**/ ?>