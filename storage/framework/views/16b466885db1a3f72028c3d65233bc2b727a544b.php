              ...
              <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                                   <div class="form-group">
                                    <label for="file">Add PDF File</label>
                                    <div class="input-group">
                                    <div class="form-group">
                                        <input type="file" name="pdf_file" class="form-control" id="file">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control textarea" type="text" rows="9" name="desc"  required id="desc" placeholder="Enter course description"></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/courses/add-courses.blade.php ENDPATH**/ ?>