            ...
            <div class="container-fluid">
               <div class="row">
                     ...
                     <div class="events__sidebar pl-70">
                        <div class="events__sidebar-widget white-bg mb-20">
                           <div class="events__sidebar-shape">
                              <img class="events-sidebar-img-2" src="#" alt="">
                              <img class="events-sidebar-img-3" src="#" alt="">
                           </div>
                  ...
                  <div class="col-xxl-8 col-xl-8 col-lg-8 pt-50">
                        ...
                        <h3 class="">Hello <?php echo e(Auth::guard('web')->User()->fullname); ?>!</h3> 
                        <div class="blog__meta d-flex align-items-center">
                           <div class="blog__author d-flex align-items-center mr-40">
                              ...
                              <div class="">
                                 <i class="fal fa-envelope" style="color:black"></i>
                                 <span style="color:black!important"><?php echo e(Auth::guard('web')->User()->email); ?></span>
                              </div>
                           </div>
                           <div class="">
                              <i class="fal fa-clock" style="color:black"></i>
                              <?php $date = date('d F Y');?>
                              <span style="color:black!important"><?php echo e(date('d F Y', strtotime($date))); ?></span>
                           </div>
                        </div>                      
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/user/dashboard.blade.php ENDPATH**/ ?>