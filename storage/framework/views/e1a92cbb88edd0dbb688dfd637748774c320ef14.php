            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                      <a href="<?php echo e(url('admin/update-features/'.$row->id)); ?>" class='btn btn-info btn-sm' title="Edit features"><i class="fas fa-edit"></i></a>
                      <a class="btn btn-default" href="<?php echo e(url('/admin/delete-paper-features/'.$row->id)); ?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash" style="color: red;"></i></a>  
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/papers/viewfeature.blade.php ENDPATH**/ ?>