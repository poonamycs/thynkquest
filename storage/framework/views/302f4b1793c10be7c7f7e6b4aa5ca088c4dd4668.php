                         ...
                         <div class="course__description pt-50">
                              ...
                              <?php $__currentLoopData = $question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <div class="col-md-6 mb-20 text-center">
                                    ...
                                    <a class="btn" href="<?php echo e(url('view-answers/'.$rows->id)); ?>"  style="color:white;background:#007ccf;font-size:20px"><i class="fa fa-eye"></i> Answers</a>
                                    <?php endif; ?>
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                              <p style="font-size:20px;text-align:justify"><?php echo $papers->description; ?></p>
                           </div>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/pages/paper-detail.blade.php ENDPATH**/ ?>