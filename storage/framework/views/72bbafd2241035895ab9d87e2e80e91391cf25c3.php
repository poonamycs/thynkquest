                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="discount" class="form-control" required id="price">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/subs/add-subsription.blade.php ENDPATH**/ ?>