                        ...
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tr>
                                        <td><?php echo e($details->exam_paper_id); ?></td>
                                        <td><?php echo e($details->paper_title); ?></td>
                                        <td><?php echo e($details->cat_name); ?></td>              
                                        <td>£<?php echo e($details->price); ?>.00  </td>              
                                        <td> <a class="btn" style="background:gainsboro;" href="<?php echo e(url('/exam-paper-detail/'.$details->exam_paper_id.'/'.$title)); ?>">View Paper</a> </td>              
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/user/exampapers-details.blade.php ENDPATH**/ ?>