               ...
               <div class="row justify-content-center">
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="course__wrapper">
                           ...
                           <div class="page__title-breadcrumb">                            
                               <nav aria-label="breadcrumb">
                                 <ol class="breadcrumb">
                                   ...
                                   <li class="breadcrumb-item"><a href="course-grid.html"><?php echo e($examdetails->cat_name); ?></a></li>
                                   <li class="breadcrumb-item active" aria-current="page"><?php echo e($examdetails->title); ?></li>
                                 </ol>
                               </nav>
                           </div>
                        ...
                        <div class="course__img pl-50">
                           <img src="<?php echo e(asset('/images/exampapers/'.$examdetails->file)); ?>" width="500px" height="500px" alt="">
                  ...
                  <div class="col-xxl-6">
                         <div class="course__description pt-50">
                              ...
                              <div class="events__tag">
                                 ...
                                 <h3>£<?php echo e($examdetails->price); ?>.00</h3>
                           ...
                           <div class="course__enroll-btn text-center pt-30">
                              <a href="<?php echo e(url('/subscription')); ?>" class="e-btn w-100" style="height:59px;font-size:25px;padding-top:5px;">Subscribe Now<i class="far fa-arrow-right"></i></a>
                        </div>
                  </div>
                                     ...
                                     <?php $__currentLoopData = $question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <div class="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                                          <div class="course__curriculum-info">
                                             <h3><a href="<?php echo e(asset('images/papers/question/'.$rows->answer_paper)); ?>" target="__blank"><?php echo e($rows->title); ?></a> </h3>
                                          </div>
                                          <div class="course__curriculum-meta">
                                             <span class="time"> <i class="icon_clock_alt"></i><a href="<?php echo e(asset('images/papers/question/'.$rows->answer_paper)); ?>" download>Question</a></span>
                                             <span class="question"><a href="<?php echo e(asset('images/papers/question/'.$rows->answer_paper)); ?>" download>Answer</a></span>
                                          </div>
                                       </div>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/exams/examdetails.blade.php ENDPATH**/ ?>