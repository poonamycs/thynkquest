              ...
              <?php echo csrf_field(); ?>
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="title">Add Question Paper</label>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img src="<?php echo e(asset('images/exampapers/question/'.$row->question_paper)); ?>" class="img-fluid" width="150px" alt=""></td>
                  <td><img src="<?php echo e(asset('images/exampapers/question/'.$row->answer_paper)); ?>" class="img-fluid" width="150px" alt=""></td>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/adminPages/exampapers/add_qpapers.blade.php ENDPATH**/ ?>