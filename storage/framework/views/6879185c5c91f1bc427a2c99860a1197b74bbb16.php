...
$papers_11 = Category::where('parent_id','=',1)->where('status','=',1)->first();
$papers_13 = Category::where('parent_id','=',2)->where('status','=',1)->first();
$examscat = ExamCategory::where('subcat',0)->where('cat_name','Non-Verbal Reasoning')->where('status','=',1)->first();
$courscat = DB::table('course_category')->where('status','=',1)->get();
$tagline = DB::table('taglines')->where('status','=',1)->first();
...
<div class="cartmini__area">
      ...
      <main>
         ...
         <section class="hero__area hero__height d-flex align-items-center grey-bg-2 p-relative">
            ...
            <div class="container">
               <div class="hero__content-wrapper mt-90 mobile-mt mt-160">
                        ...
                        <div class="hero__thumb d-flex p-relative">
                           ...
                           <div class="hero__thumb-big mr-30">
                              ...
                              <div class="hero__quote hero__quote-animation">
                                 ...
                                 <a href="<?php echo e(url('/personalised_assistance')); ?>">Contact Now</a>
                              </div>
                              </div>
                           </div>
               ...
               <div class="row">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <img src="<?php echo e(asset('images/Pre-11+ Foundation.png')); ?>" width="40px" alt="" class="exp-icon">
                        </div>
                        <div class="category__content">
                             <?php $title = str_replace(array(" ","/"),'-',$papers_11->cat_name); ?>
                           <h4 class="category__title"><a href="<?php echo e(url('papers/'.$papers_11->id.'/'.$title)); ?>">11+ Mark Schemes</a></h4>
                  ...
                  <!--      </div>-->
                  <!--      <div class="category__content">-->
                  <!--         <h4 class="category__title"><a href="<?php echo e(url('/reach-you-soon')); ?>">Pre-11+ Foundation Courses</a></h4>-->
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        <div class="category__icon mr-30">
                        <img src="<?php echo e(asset('images/Exam Booster.png')); ?>" width="40px" alt="" class="exp-icon">
                        </div>
                        <div class="category__content">
                           <?php if($courscat): ?>
                           <h4 class="category__title"><a href="<?php echo e(url('courses/'.$cat->cat_name)); ?>"><?php echo e($cat->cat_name); ?></a></h4>
                           <p><?php echo e($cat->Subtitle); ?></p>
                           <?php else: ?>
                  ...
                  <!--      </div>-->
                  <!--      <div class="category__content">-->
                  <!--         <h4 class="category__title"><a href="<?php echo e(url('/reach-you-soon')); ?>">13+ Scholarship Courses</a></h4>-->
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        <div class="category__icon mr-30">
                        <img src="<?php echo e(asset('images/Mock Exams.png')); ?>" width="40px" alt="" class="exp-icon">
                        </div>
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('/reach-you-soon')); ?>">Mock Exams</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        <div class="category__icon mr-30">
                        <img src="<?php echo e(asset('images/VR.png')); ?>" width="40px" alt="" class="exp-icon">
                        </div>
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('/reach-you-soon')); ?>">Verbal Reasoning</a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <img src="<?php echo e(asset('images/NVR.png')); ?>" width="40px" alt="" class="exp-icon">
                        </div>
                        
                        <div class="category__content">
                            <?php $title = str_replace(array(" ","/"),'-',$examscat->cat_name); ?>
                           <h4 class="category__title"><a href="<?php echo e(url('exam-papers/'.$examscat->cat_name)); ?>">Non Verbal Reasoning</a></h4>
                           <p>11+ and 13+ resources</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        <div class="category__icon mr-30">
                           <img src="<?php echo e(asset('images/creative writing.png')); ?>" width="40px" alt="" class="exp-icon">
                        </div>
                        <div class="category__content">
                           <h4 class="category__title"><a href="<?php echo e(url('/reach-you-soon')); ?>">English Creative Writing</a></h4>
                           <p>11+ and 13+ guide</p>
                        </div>
                     </div>
                  </div>
...
.container-r1 #btn-cr:hover {
  background-color: black;
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div class="banner__item p-relative mb-40" data-background="">
                        <div class="banner__thumb d-none d-sm-block d-md-none d-lg-block">
                           ...
                           <a href="<?php echo e(url('all-courses')); ?>" class="e-btn" id="btn-cr">view all courses</a>
                        </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     ...
                     <div class="banner__item p-relative mb-40" data-background="<?php echo e(asset('images/tagline/'.$tagline->image1)); ?>" style="background-image: url(&quot;<?php echo e(asset('images/tagline/'.$tagline->image1)); ?>&quot;);">
                        <div class="banner__content">
                           <!-- <span>Trending</span> -->
                           <h3 class="banner__title">
                              <!--<a href="#">11+ <br> Accelerating Courses</a><br>-->
                              
                            <p class="text-dark" style="font-weight:600;"><a href="<?php echo e(url(''.$tagline->urlone)); ?>" class="e-btn e-btn-2"> <?php echo e($tagline->tagline); ?> </a></p>
                             
                           </h3>
                            
                           <!-- <a href="<?php echo e(url('all-courses')); ?>" class="e-btn e-btn-2">Subscribe</a> -->
                        </div>
                        <div class="banner__thumb d-none d-sm-block d-md-none d-lg-block">
                           <img src="#" alt="">
                        </div>
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                      <?php if(!empty($tagline)): ?>
                     <div class="banner__item p-relative mb-40" data-background="<?php echo e(asset('images/tagline/'.$tagline->image2)); ?>" style="background-image: url(&quot;<?php echo e(asset('images/tagline/'.$tagline->image2)); ?>&quot;);">
                        <div class="banner__content">
                           <!-- <span class="orange">Upcoming</span> -->
                           <h3 class="banner__title">
                              <!--<a href="#">11+ Christmas<br>Break Courses</a><br>-->
                              
                             <p class="text-dark" style="font-weight:600;"><a href="<?php echo e(url(''.$tagline->urltwo)); ?>" class="e-btn e-btn-2"> <?php echo e($tagline->taglinetwo); ?></a> </p>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7 text-center margin-100px-bottom sm-margin-40px-bottom">
                       <div class="section__title-wrapper mb-45">
                        <h2 class="section__title">Testimonials
                        </h2>
                     </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="col-12 col-lg-4 col-md-6 swiper-slide md-margin-four-bottom">
                                <div class="margin-half-all bg-white box-shadow-light text-center padding-fourteen-all sm-padding-30px-all">
                                    <!-- <img src="http://placehold.it/149x149" class="rounded-circle width-40 margin-25px-bottom md-margin-15px-bottom" alt=""/> -->
                                    <p class="md-margin-15px-bottom sm-margin-20px-bottom"><?php echo nl2br($test->description); ?> </p>
                                    <p class="font-weight-600 text-dark"><?php echo e($test->student_name); ?></p>
                                    <p class="font-weight-600 text-dark"><?php echo e($test->designation); ?></p>
         ...
         <!-- pricing area start -->
         <section class="counter__area pb-100 pt-120">
            <div class="container">
               <div class="row">
...
<!--      <div id="pop-up-box" style="display:block;z-index:9999;width:20%;padding: 5px 0px 10px-->
<!--0px;right:0px;font-size:14px;font-weight:600;color:#ffffff;background-color:#ffffff;bottom:45px;position:fixed;text-align:center;"-->
<!--class="fixed-announcement"><a target="_blank"-->
<!--href="<?php echo e(url('farmers_content')); ?>"-->
<!--style="text-decoration:none;color:#000000;">10+ Parents Registered Successfully</a></div>-->
...
<!--    (function () {-->
<!--        var options = {-->
            <!--whatsapp: "+91 9284480268", // WhatsApp number-->
            <!--call_to_action: "Message us", // Call to action-->
            <!--position: "left", // Position may be 'right' or 'left'-->
            <!--pre_filled_message: "Any One there from ThynkQuest..?", // WhatsApp pre-filled message-->
<!--        };-->
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/index.blade.php ENDPATH**/ ?>