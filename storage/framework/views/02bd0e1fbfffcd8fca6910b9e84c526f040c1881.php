                                 ...
                                 <div class="row">
                                    ...
                                    <form  action="<?php echo e(route('exam.style.paper.payment')); ?>" method="post"  >
                                       ...
                                       <script
                                          ...
                                          <input type="hidden" name="exam_paper_id" value="<?php echo e($package->exam_paper_id); ?>" >
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/pages/exam-checkout.blade.php ENDPATH**/ ?>