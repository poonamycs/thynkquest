                           ...
                           <div class="footer__widget mb-50">
                              <div class="footer__widget-head mb-22">
                                 <div class="footer__logo">
                                    ...
                                    <img src="<?php echo e(asset ('img/logo/ThynkQuest-2.svg')); ?>" width="140px" alt="logo">
                                    </a>
                                 </div>
                              </div>
...
solve mankind’s greatest problems.</p>
                                 <div class="footer">
                                    <ul>
                                       <li><a href="<?php echo e(url('/terms_and_conditions')); ?>">Term Of Use</a> <a href="<?php echo e(url('/privacy_policy')); ?>" class="ml-5">Privacy Policy</a><a href="<?php echo e(url('/contact')); ?>" class="fb ml-10">Get Intouch</a></li>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-5 col-sm-6">
                           <div class="footer__widget footer__pl-70 mb-50">
                              ...
                              <!-- <div class="pl-30" >
                                ...
                                <a href="<?php echo e(url('/contact')); ?>" class="fb">Get Intouch</a>
                              </div> --> 
         ...
         </footer><?php /**PATH D:\xampp\htdocs\ycs-projects\thynkquest\resources\views/layouts/front_layout/front_footer.blade.php ENDPATH**/ ?>