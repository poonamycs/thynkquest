            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <a href="<?php echo e(url('admin/edit-title/'.$row->id)); ?>" class='btn btn-info' title="Edit answer"><i class="fas fa-edit"></i></a> 
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/papers/add_qpapers.blade.php ENDPATH**/ ?>