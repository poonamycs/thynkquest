              ...
              <?php echo csrf_field(); ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" name="cat_desc" rows="9" class="form-control" required id="desc" placeholder="Enter paper description"></textarea>
                  </div>
                  <!-- <div class="form-group">
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/categories/add-cat.blade.php ENDPATH**/ ?>