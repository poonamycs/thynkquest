                                 ...
                                 <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                                    ...
                                    <div class="price__offer">
                                       ...
                                       <div class="price__tag mb-25">
                                          <h4>£ <?php echo e($plan->price); ?><span>/ <?php echo e($plan->subs_type); ?> Months</span></h4>
                                       </div>
                                       <div class="price__features mb-40">
                                          <ul>
                                             <?php  
                                                $features = DB::table('paper_features')->where('paper_id',$plan->paper_id)->get();                                             
                                             ?>
                                           

                                           <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <li><i class="far fa-check"></i><?php echo e($feature->feature); ?></li>
                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                          </ul>
                                       </div>
                                    
                                    
                                     <!--<a href="#" class="e-btn e-btn-4">View Details</a>-->
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                    ...
                                    <div class="price__offer">
                                       ...
                                       <div class="price__features mb-40">
                                          <ul>
                                          <?php  
                                                $features = DB::table('exam_paper_feature')->where('paper_id',$plan->exam_paper_id)->get();                                             
                                             ?>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/user/subscription.blade.php ENDPATH**/ ?>