                                 ...
                                 <div class="tab-content" id="courseTabContent">
                                          ...
                                          <div class="course__curriculum">
                                             <div class="accordion-body">
                                                <div class="course__img">
                                                   <img src="<?php echo e(asset('images/papers/answers/'.$row->question_img)); ?>" width="600px" height="500px" alt="">
                                       ...
                                       <div class="tab-pane fade" class="" id="member<?php echo e($row->id); ?>" role="tabpanel" aria-labelledby="member-tab">
                                          <div class="course__member ">
                                             <div class="accordion-body">
                                                <div class="course__img">
                                                   <img src="<?php echo e(asset('images/papers/answers/'.$row->answer_img)); ?>" width="600px" height="500px" alt="">
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/pages/view-answers.blade.php ENDPATH**/ ?>