                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="contact__wrapper">
                        <div class="section__title-wrapper mb-40">
                           <h2 class="section__title">Enquiry</h2>
                          
                        </div>
                        <div class="contact__form">
                           <form action="<?php echo e(url('/one_to_one_enquiry_form')); ?>" method="post">
                               <?php echo csrf_field(); ?>
                              <div class="row">
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/courses/enquiry_form.blade.php ENDPATH**/ ?>