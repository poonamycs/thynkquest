                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       <a href="<?php echo e(url('examm-paper-detail/'.$exam->id.'/'.$title)); ?>">
                                             <img src="<?php echo e(asset('/images/exampapers/'.$exam->file)); ?>" width="100%" height="200px"  alt="">
                                          </a>
                                       <div class="course__content">
                                         
                                          <h3 class="course__title"><a href="<?php echo e(url('examm-paper-detail/'.$exam->id.'/'.$title)); ?>"><?php echo e($exam->title); ?>.</a></h3>
                                          <div class="course__teacher d-flex align-items-center">
                                             <!-- <div class="course__teacher-thumb mr-15">
                                                <img src="assets/img/course/teacher/teacher-1.jpg" alt="">
                                             </div> -->
                                             <h3><a href="<?php echo e(url('examm-paper-detail/'.$exam->id.'/'.$title)); ?>"><?php echo e($exam->subcat_name); ?></a></h3>
                                             
                                          </div>
                                       </div>
                                       <div class="course__more d-flex justify-content-between align-items-center">
                                          <div class="course__status">
                                             <span>£<?php echo e($exam->price); ?>.00</span>
                                          </div>
                                          <div class="course__btn">
                                             <a href="<?php echo e(url('examm-paper-detail/'.$exam->id.'/'.$title)); ?>" class="link-btn">
                                                Know Details
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/exams/exampapers.blade.php ENDPATH**/ ?>