...
<header>
                                        ...
                                        <section class="category__area pt-20">
                                           <div class="container">
                                            <div class="row">
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                                   <div class="menu-border mb-30">
                                                        <a href="<?php echo e(url('/reach-you-soon')); ?>" style="padding-left:25px;font-size:22px;" >Mock Exams</a>
                                                   </div>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                                   <div class="menu-border mb-30">
                                                        <a href="<?php echo e(url('/personalized_assistance')); ?>" style="padding-left:25px;font-size:22px;" >Personalized Assistance</a>
                                                   </div>
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                                   <div class="menu-border mb-30">
                                                        <a href="<?php echo e(url('/free_resources')); ?>" style="padding-left:25px;font-size:22px;" >Free 11+ Resources</a>
                                                   </div>
                                                </div>
                                            </div>
                                           </div>
      ...
      </header><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/layouts/front_layout/front_header.blade.php ENDPATH**/ ?>