            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo e(url('admin/edit-answers/'.$row->id)); ?>" class='btn btn-info btn-sm' title="Edit Paper"><i class="fas fa-edit"></i></a>  
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/papers/add-answers.blade.php ENDPATH**/ ?>