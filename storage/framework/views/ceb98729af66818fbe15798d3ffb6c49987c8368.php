...
<aside class="main-sidebar sidebar-dark-red elevation-4" style="background:#0c0302">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo e(url('admin/dashboard')); ?>" class="d-block"><?php echo e(Session::get('adminSession')); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('admin/seo')); ?>" class="nav-link <?php if(preg_match("/seo/", $url)){ ?>  active-bg <?php } ?>">
          ...
          <li class="nav-item">
                <a href="<?php echo e(url('admin/view-currency-rate')); ?>" class="nav-link <?php if(preg_match("/view-currency-rate/", $url)){ ?>active-bg  <?php } ?>">
                <i class="nav-icon fas fa-th"></i>
                 <p>Currency Rate</p>
                </a>
          </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('admin/add-testimonial')); ?>" class="nav-link <?php if(preg_match("/add-testimonial/", $url)){ ?>active-bg  <?php } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Testimonial</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/view-testimonial')); ?>" class="nav-link <?php if(preg_match("/view-testimonial/", $url)){ ?>active-bg  <?php } ?>">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-tree"></i>
              <p>
                One to One tutoring Subjects
                <i class="fas fa-angle-left right"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('admin/add-subject')); ?>" class="nav-link <?php if(preg_match("/add-subject/", $url)){ ?>active-bg  <?php } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Subject</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/view-subject')); ?>" class="nav-link <?php if(preg_match("/view-subject/", $url)){ ?>active-bg  <?php } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Subject</p>
                </a>
              </li> 
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-tree"></i>
              <p>
               Personalized Assistant Subjects
                <i class="fas fa-angle-left right"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('admin/add-personalizedSubject')); ?>" class="nav-link <?php if(preg_match("/add-subject/", $url)){ ?>active-bg  <?php } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Subject</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/view-personalizedSubject')); ?>" class="nav-link <?php if(preg_match("/view-subject/", $url)){ ?>active-bg  <?php } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Subject</p>
                </a>
              </li> 
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                  <a href="<?php echo e(url('admin/view-terms-conditions')); ?>" class="nav-link <?php if(preg_match("/view-terms-conditions/", $url)){ ?>active-bg  <?php } ?>">
                   <i class="far fa-circle nav-icon"></i>
                  <p>Terms And Conditions</p>
                  </a>
                 </li>
                 <li class="nav-item">
                  <a href="<?php echo e(url('admin/view-privacy-policy')); ?>" class="nav-link <?php if(preg_match("/privacy-policy/", $url)){ ?>active-bg  <?php } ?>">
                   <i class="far fa-circle nav-icon"></i>
                  <p>Privacy Policy</p>
                  </a>
                  </li>
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="<?php echo e(url('admin/view-onetone-enquiry')); ?>" class="nav-link <?php if(preg_match("/view-onetone-enquiry/", $url)){ ?>active-bg  <?php } ?>">
                 <i class="nav-icon fas fa-th"></i>
                 <p>One-To-One Tutoring Subscription</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/view-personalized-enquiry')); ?>" class="nav-link <?php if(preg_match("/view-personalized-enquiry/", $url)){ ?>active-bg  <?php } ?>">
                 <i class="nav-icon fas fa-th"></i>
                 <p>Personalized Assistant Enquiry</p>
                </a>
              </li>
              <li class="nav-item">
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/layouts/back_layout/sidebar.blade.php ENDPATH**/ ?>