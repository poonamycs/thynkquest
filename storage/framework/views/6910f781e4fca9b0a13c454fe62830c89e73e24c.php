                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           ...
                           <h4 class="category__title"><a href="<?php echo e(url('courses/'.$cat->id.'/'.$title)); ?>"><?php echo e($cat->cat_name); ?></a></h4>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           ...
                           <h4 class="category__title"><a href="<?php echo e(url('exam-papers/'.$examscat->id.'/'.$title)); ?>">Non Verbal Reasoning</a></h4>
                           <p>11+ and 13+ resources</p>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="col-12 col-lg-4 col-md-6 swiper-slide md-margin-four-bottom">
                                <div class="margin-half-all bg-white box-shadow-light text-center padding-fourteen-all sm-padding-30px-all">
                                    ...
                                    <p class="md-margin-15px-bottom sm-margin-20px-bottom"><?php echo strip_tags($test->description); ?> </p>
               ...
               <div class="row">
                  <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3">
                     <div class="section__title-wrapper text-center mb-60">
                        <h2 class="section__title">We are <span class="yellow-bg yellow-bg-big">Proud<img src="#" alt=""></span></h2>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ycs-projects\thynkquest\resources\views/index.blade.php ENDPATH**/ ?>