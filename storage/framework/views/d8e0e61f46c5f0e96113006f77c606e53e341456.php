...
<script>
  function SeeMessage(id){
      $.ajax({
        type:"get",
        url:"<?php echo e(url('admin/one-to-one-enquiry')); ?>",
        data:{id:id},
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/one-to-one-tutoring.blade.php ENDPATH**/ ?>