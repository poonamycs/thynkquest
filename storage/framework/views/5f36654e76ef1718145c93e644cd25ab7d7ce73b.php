                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       <div class="course__thumb w-img p-relative fix">
                                          <a href="<?php echo e(url('course-detail')); ?>">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <h3 class="course__title"><a href="<?php echo e(url('course-detail')); ?>">Become a product Manager learn the skills & job.</a></h3>
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <h3 class="course__title"><a href="<?php echo e(url('course-detail')); ?>">Fundamentals of music theory Learn new</a></h3>
                                          <div class="course__teacher d-flex align-items-center">
                                             <div class="course__teacher-thumb mr-15">
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <h3 class="course__title"><a href="<?php echo e(url('course-detail')); ?>">Bases Matemáticas dios Álgebra Ecuacion</a></h3>
                                          <div class="course__teacher d-flex align-items-center">
                                             <div class="course__teacher-thumb mr-15">
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <h3 class="course__title"><a href="<?php echo e(url('course-detail')); ?>">Strategy law and organization Foundation</a></h3>
                                          <div class="course__teacher d-flex align-items-center">
                                             <div class="course__teacher-thumb mr-15">
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <h3 class="course__title"><a href="<?php echo e(url('course-detail')); ?>">The business Intelligence analyst Course 2022</a></h3>
                                          <div class="course__teacher d-flex align-items-center">
                                             <div class="course__teacher-thumb mr-15">
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <h3 class="course__title"><a href="<?php echo e(url('course-detail')); ?>">Build your media and Public presence</a></h3>
                                          <div class="course__teacher d-flex align-items-center">
                                             <div class="course__teacher-thumb mr-15">
                                 ...
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <h3 class="course__title"><a href="<?php echo e(url('course-detail')); ?>">Creative writing through Storytelling</a></h3>
                                          <div class="course__teacher d-flex align-items-center">
                                             <div class="course__teacher-thumb mr-15">
                                             ...
                                             <div class="course__right">
                                                <div class="course__content course__content-3">
                                                   ...
                                                   <h3 class="course__title course__title-3">
                                                      <a href="<?php echo e(url('course-detail')); ?>">Become a product Manager learn the skills & job.</a>
                                                   </h3>
                                          ...
                                          <div class="col-xxl-8 col-xl-8 col-lg-8">
                                             <div class="course__right">
                                                <div class="course__content course__content-3">
                                                   ...
                                                   <h3 class="course__title course__title-3">
                                                      <a href="<?php echo e(url('course-detail')); ?>">Fundamentals of music theory Learn new.</a>
                                                   </h3>
                                                   <div class="course__summary">
                                                      <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem</p>
                                                   </div>
                                          ...
                                          <div class="col-xxl-8 col-xl-8 col-lg-8">
                                             <div class="course__right">
                                                <div class="course__content course__content-3">
                                                   ...
                                                   <h3 class="course__title course__title-3">
                                                      <a href="<?php echo e(url('course-detail')); ?>">Strategy law and organization Foundation</a>
                                                   </h3>
                                                   <div class="course__summary">
                                                      <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem</p>
                                                   </div>
                                          ...
                                          <div class="col-xxl-8 col-xl-8 col-lg-8">
                                             <div class="course__right">
                                                <div class="course__content course__content-3">
                                                   ...
                                                   <h3 class="course__title course__title-3">
                                                      <a href="<?php echo e(url('course-detail')); ?>">The business Intelligence analyst Course 2022</a>
                                                   </h3>
                                                   <div class="course__summary">
                                                      <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem</p>
                                                   </div>
                                          ...
                                          <div class="col-xxl-8 col-xl-8 col-lg-8">
                                             <div class="course__right">
                                                <div class="course__content course__content-3">
                                                   ...
                                                   <h3 class="course__title course__title-3">
                                                      <a href="<?php echo e(url('course-detail')); ?>">Build your media and Public presence</a>
                                                   </h3>
                                                   <div class="course__summary">
                                                      <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem</p>
                                                   </div>
                                          ...
                                          <div class="col-xxl-8 col-xl-8 col-lg-8">
                                             <div class="course__right">
                                                <div class="course__content course__content-3">
                                                   ...
                                                   <h3 class="course__title course__title-3">
                                                      <a href="<?php echo e(url('course-detail')); ?>">Creative writing through Storytelling</a>
                                                   </h3>
                                                   <div class="course__summary">
                                                      <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem</p>
                                                   </div>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/pages/course-grid.blade.php ENDPATH**/ ?>