    ...
    <div class="container-fluid ">
        ...
        <div class="col-md-10 pt-5">
            ...
            <div class="card card-default">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form"  action="<?php echo e(url('admin/edit-title/'.$question->id)); ?>" enctype='multipart/form-data' method="Post">
              <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                     <div class="col-md-12">
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/papers/edit_title.blade.php ENDPATH**/ ?>