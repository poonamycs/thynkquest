...
<aside class="main-sidebar sidebar-dark-red elevation-4" style="background:#0c0302">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('admin/view-explore-more')); ?>" class="nav-link <?php if(preg_match("/view-explore-more/", $url)){ ?>active-bg  <?php } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Explore More</p>
                </a>
              </li>
             ...
             <li class="nav-item">
            <a href="<?php echo e(url('admin/view-enquiry')); ?>" class="nav-link <?php if(preg_match("/view-enquiry/", $url)){ ?>active-bg  <?php } ?>">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Contact Enquiry
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH D:\xampp\htdocs\laravel-project\thynkquest\resources\views/layouts/back_layout/sidebar.blade.php ENDPATH**/ ?>