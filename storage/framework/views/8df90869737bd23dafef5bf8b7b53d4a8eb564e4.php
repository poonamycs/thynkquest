...
<main>
         ...
         <section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="<?php echo e(asset('img/page-title/page-title.jpg')); ?>" style="background-image: url(&quot;assets/img/page-title/page-title.jpg&quot;);">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="page__title-wrapper mt-110">
                        ...
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="https://themepure.net/template/educal/educal/index.html">Home</a></li>
                  ...
                  <div class="col-xxl-7 col-xl-7 col-lg-6">
                     <div class="contact__wrapper">
                        <div class="section__title-wrapper mb-40">
                           <h2 class="section__title">Get in<span class="yellow-bg yellow-bg-big">touch<img src="./Educal – Online Learning and Education HTML5 Template_files/yellow-bg.png" alt=""></span></h2>
                     ...
                     <div class="contact__info white-bg p-relative z-index-1">
                        ...
                        <div class="contact__info-inner white-bg">
                           ...
                           <div class="contact__social pl-30">
                              <h4>Follow Us</h4>
                              <ul>
                                 <li><a href="https://themepure.net/template/educal/educal/contact.html#" class="fb"><i class="social_facebook"></i></a></li>
                                 <li><a href="https://themepure.net/template/educal/educal/contact.html#" class="tw"><i class="social_twitter"></i></a></li>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/pages/contact.blade.php ENDPATH**/ ?>