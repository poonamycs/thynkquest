              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <a href="<?php echo e(url('admin/add-exam-answers/'.$row->id)); ?>"  class='btn btn-success' title="add answers"><i class="fas fa-plus"></i></a>
                   <a href="<?php echo e(url('admin/edit-examtitle/'.$row->id)); ?>" class='btn btn-info' title="Edit answer"><i class="fas fa-edit"></i></a>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/exampapers/add_qpapers.blade.php ENDPATH**/ ?>