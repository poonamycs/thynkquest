...
<html class="no-js" lang="zxx">
   <head>
      ...
      <meta http-equiv="x-ua-compatible" content="ie=edge">
       <title><?php if(!empty($meta_title)): ?> <?php echo e($meta_title); ?> <?php else: ?> ThynkQuest – Online Learning and Education <?php endif; ?></title>
    
       <?php 
           $seocontent =  DB::table('seo_content')->where('id',1)->first();
       ?>
      <meta name="description" content="<?php echo e($seocontent->description); ?>">
      <meta name="keywords" content="<?php echo e($seocontent->keywords); ?>">
...
<?php /**PATH D:\xampp\htdocs\ycs-projects\thynkquest\resources\views/layouts/front_layout/front_design.blade.php ENDPATH**/ ?>