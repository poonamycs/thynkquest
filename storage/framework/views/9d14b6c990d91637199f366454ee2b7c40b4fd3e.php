                        ...
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <td> <a class="btn" style="background:gainsboro;" href="<?php echo e(url('/courses-detail/'.$row->id.'/'.$title)); ?>">View Details</a> </td>              
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-project\thynkquest\resources\views/user/mycourses.blade.php ENDPATH**/ ?>