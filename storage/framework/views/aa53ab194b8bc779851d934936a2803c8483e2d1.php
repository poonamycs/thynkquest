            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-responsive">
                ...
                <tr>
                  ...
                  <!--<td><?php echo Str::limit(strip_tags($row->comment),40); ?></td>-->
                  ...
                  <td class="d-flex">
                   ...
                   <a href="<?php echo e(url('admin/deletePersonalizedenquiry/'.$row->id)); ?>" onclick="return confirm('Are you sure? You want to delete this category.')" class='btn btn-danger' title="Delete Category"><i class="fas fa-trash-alt"></i></a> 
                </td>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/personalisedenquiryform.blade.php ENDPATH**/ ?>