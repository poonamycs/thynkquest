...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>13+ Mark Schemes Papers</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">13+ Papers</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <div class="row">
    ...
    <div class="card">
            <div class="card-header">
              ...
              <a href="<?php echo e(url('admin/add-13-papers')); ?>" class="btn btn-primary thynk float-right">Add Papers</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/papers/view-13-papers.blade.php ENDPATH**/ ?>