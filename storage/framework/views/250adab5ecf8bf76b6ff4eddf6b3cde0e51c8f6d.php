                  ...
                  <div class="col-xxl-12">
                     <div class="page__title-wrapper mt-145">
                        ...
                        <h3 class="page__title"><?php echo e($courselist[0]->cat_name); ?></h3> 
                         ...
                         <h5 class="text-white" style="font-size:55px;">Reach Soon</h5>
                        <?php endif; ?>
                        ...
                        <div class="tab-content" id="courseTabContent">
                           <div class="tab-pane fade show active" id="grid" role="tabpanel" aria-labelledby="grid-tab">
                              <div class="row">
                                 ...
                                 <?php $title = Str::slug($list->title); ?>
                                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                    <div class="course__thumb w-img p-relative fix">
                                          <a href="<?php echo e(url('courses-detail/'.$list->title)); ?>">
                                             <img src="<?php echo e(asset('/images/courses/'.$list->image)); ?>" width="300px" height="200"  alt="<?php echo e($title); ?>">
                                          </a>
                                 ...
                                 <?php else: ?>
                                 <h1 class="text-center">We Will Reach You Soon !!</h1>
                                 <?php endif; ?>
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/courses/courselist.blade.php ENDPATH**/ ?>