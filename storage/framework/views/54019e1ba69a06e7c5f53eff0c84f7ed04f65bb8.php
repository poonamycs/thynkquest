    ...
    <div class="container-fluid ">
        ...
        <div class="col-md-10">
            ...
            <div class="card card-default">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="PaperForm" action="<?php echo e(url('admin/add-papers')); ?>" enctype='multipart/form-data' method="Post">
              <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="school" required id="school" style="width: 100%;">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="desc" rows="9" class="form-control textarea" required id="desc" placeholder="Enter paper description"></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x9qb580ys622/public_html/thynkquest.ycstech.live/resources/views/adminPages/papers/add-papers.blade.php ENDPATH**/ ?>