...
<main>
<section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="" style="background-color: rgb(218, 47, 88);">
            <div class="container">
               <div class="row">
                                 ...
                                 <div class="tab-content" id="courseTabContent">
                                          ...
                                          <div class="course__curriculum">
                                             <div class="accordion-body">
                                                <div class="course__img">
                                                   <img src="<?php echo e(asset('images/exampapers/answers/'.$row->question_img)); ?>"alt="" style="border: 2px solid #555;">
                                       ...
                                       <div class="tab-pane fade" class="" id="member<?php echo e($row->id); ?>" role="tabpanel" aria-labelledby="member-tab">
                                          <div class="course__member ">
                                             <div class="accordion-body">
                                                <div class="course__img">
                                                   <img src="<?php echo e(asset('images/exampapers/answers/'.$row->answer_img)); ?>"  alt="" style="border: 2px solid #555;">
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ycs-projects\thynkquest\resources\views/exams/view-exam-answers.blade.php ENDPATH**/ ?>