                                    ...
                                    <div class="row">
                                        <div class="sign__input-wrapper mb-25">
                                            ...
                                            <div class="sign__input">
                                                <input type="text" name="name" required value="<?php echo e(Auth::guard('web')->User()->fullname); ?>">
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Email</h5>
                                            <div class="sign__input">
                                                <input type="text" name="email" value="<?php echo e(Auth::guard('web')->User()->email); ?>">
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ycs-projects\thynkquest\resources\views/user/myprofile.blade.php ENDPATH**/ ?>