...
<header>
                           ...
                           <nav id="mobile-menu">
                              <ul>
                                 <li class="has-dropdown">
                                    <a href="<?php echo e(url('/courses')); ?>">11+ Mark Schemes</a>
                                    <ul class="submenu">
                                 ...
                                 <li class="has-dropdown">
                                    <a href="<?php echo e(url('/courses')); ?>">13+ Marks Schemes</a>
                                    <ul class="submenu">
                                       <section class="category__area pt-20">
                                          <div class="container">
                                 ...
                                 <li class="has-dropdown">
                                    <a href="<?php echo e(url('/courses')); ?>">Exam Style Papers</a>
                                    <ul class="submenu">
                                      <section class="category__area pt-20">
                                          <div class="container">
                                 ...
                                 <li><a href="<?php echo e(url('/subscription')); ?>" >Explore More</a></li>
      ...
      </header><?php /**PATH C:\xampp\htdocs\thynkquest\resources\views/layouts/front_layout/front_header.blade.php ENDPATH**/ ?>