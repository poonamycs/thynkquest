...
<header>
                     ...
                     <div class="header__left d-flex">
                        <div class="logo">
                           <a href="<?php echo e(url('/')); ?>">
                              <img src="<?php echo e(asset ('img/logo/ThynkQuest-2.svg')); ?>" width="150px" alt="logo">
                           </a>
                        </div>
                                          ...
                                          <div class="container">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                                   <div class="menu-border mb-30">
                                                        <a href="<?php echo e(url('exam-papers/'.$rows->cat_name)); ?>" style="padding-left:12px;font-size:22px;" ><?php echo e($rows->cat_name); ?></a>
                                       ...
                                       <section class="category__area pt-20">
                                          <div class="container">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                                   <div class="menu-border mb-30">
                                                        <a href="<?php echo e(url('courses/'.$cat->cat_name)); ?>" class="menu-text"><?php echo e($cat->cat_name); ?></a>
                                                ...
                                                <?php endif; ?>
                                                 <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                                   ...
                                                   <?php else: ?>
                                                   <div class="menu-border mb-30">
                                                        <a href="<?php echo e(url('sign-in')); ?>" class="menu-text" >One-To-One Tutoring</a>
      ...
      </header><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/layouts/front_layout/front_header.blade.php ENDPATH**/ ?>