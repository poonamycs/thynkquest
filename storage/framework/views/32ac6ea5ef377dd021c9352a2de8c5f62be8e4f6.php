                        ...
                        <div class="hero__thumb d-flex p-relative">
                           ...
                           <div class="hero__thumb-big mr-30">
                              ...
                              <div class="hero__quote hero__quote-animation">
                                 ...
                                 <a href="<?php echo e(url('/personalized_assistance')); ?>">Contact Now</a>
                              </div>
                              </div>
                           </div>
  ...
  background-color: black;
         ...
         <section class="banner__area pb-110">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div class="banner__item p-relative mb-40" data-background="<?php echo e(asset('img/banner/Trending_bg.jpg')); ?>" style="background-image: url(&quot;<?php echo e(asset('img/banner/Trending_bg.jpg')); ?>&quot;);">
                        <div class="banner__content">
                           <span>Trending</span>
                           <h3 class="banner__title">
                              <!--<a href="#">11+ <br> Accelerating Courses</a><br>-->
                              <?php if(!empty($tagline)): ?>
                            <p class="text-dark" style="font-weight:600;"> <?php echo e($tagline->tagline); ?> </p>
                              <?php endif; ?>
                           </h3>
                           <a href="<?php echo e(url('all-courses')); ?>" class="e-btn e-btn-2">Enroll Now</a>
                        </div>
                        <div class="banner__thumb d-none d-sm-block d-md-none d-lg-block">
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div class="banner__item p-relative mb-40" data-background="<?php echo e(asset('img/banner/Upcoming_bg.jpg')); ?>" style="background-image: url(&quot;<?php echo e(asset('img/banner/Upcoming_bg.jpg')); ?>&quot;);">
                        <div class="banner__content">
                           <span class="orange">Upcoming</span>
                           <h3 class="banner__title">
                              <!--<a href="#">11+ Christmas<br>Break Courses</a><br>-->
                               <?php if(!empty($tagline)): ?>
                             <p class="text-dark" style="font-weight:600;"> <?php echo e($tagline->taglinetwo); ?> </p>
                              <?php endif; ?>
                           </h3>
                           <a href="<?php echo e(url('all-courses')); ?>" class="e-btn e-btn-2">Enroll Now</a>
                        </div>
