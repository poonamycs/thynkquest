              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $__currentLoopData = $examcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td> <a href='javascript.void(0)' onclick='EditCategory( <?php echo e($row->id); ?> )' data-toggle="modal" data-target="#modal-default" class='btn btn-info' title="Edit Category"><i class="fas fa-edit"></i></a>
                     <a href="<?php echo e(url('admin/delete-exam-category/'.$row->id)); ?>" onclick="return confirm('Are you sure? You want to delete this category.')" class='btn btn-danger' title="Delete Category"><i class="fas fa-trash-alt"></i></a>
                    </td>
...
<?php echo $__env->make('layouts.back_layout.back_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/adminPages/examcat/view-cat.blade.php ENDPATH**/ ?>