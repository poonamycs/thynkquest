...
<main>
         ...
         <section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="<?php echo e(asset('img/page-title/blog.jpg')); ?>">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="page__title-wrapper mt-145">
                        <h3 class="page__title" style="text-shadow: 2px 1px 1px #5c5c5c">Blogs</h3>                         
               ...
               <div class="row">
                  <div class="col-xxl-12 col-xl-12 col-lg-12">
                     <div class="row">
                        ...
                        <?php $title = Str::slug($blog->blog_title); ?>
                     ...
                     <!--   <div class="container">-->
                     <!--      <div class="cta__inner fix" style="background-image: linear-gradient(to right, rgb(255, 81, 47) 0%, rgb(213, 42, 93) 100%)">-->
...
<?php echo $__env->make('layouts/front_layout/front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tu969uxjwrf1/public_html/resources/views/pages/blogs.blade.php ENDPATH**/ ?>